...
const STATUS_STYLES: Record<ReceiptStatus, string> = {
  ...
  partially_allocated: 'bg-emerald-200 text-emerald-800 dark:bg-emerald-900/50',
  fully_allocated: 'bg-emerald-200 text-emerald-800 dark:bg-emerald-900/50',
  unallocated: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30',
  advance: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30',
      ...
      <div className="card flex flex-wrap items-end gap-3 p-4">
        ...
        <div>
          ...
          <select className="input" value={status} onChange={(e) => setStatus(e.target.value as ReceiptStatus | '')}>
            ...
            {(['draft', 'pending_approval', 'approved', 'ready_to_post', 'posted', 'on_hold', 'reversal_requested', 'reversed', 'cancelled_before_posting', 'sync_pending', 'sync_failed', 'conflict'] as ReceiptStatus[]).map((s) => (
